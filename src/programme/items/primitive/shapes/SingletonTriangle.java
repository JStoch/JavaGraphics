...
import programme.Singleton;
import programme.items.Item;
import programme.items.primitive.Primitive;

import java.awt.*;

public class SingletonTriangle extends Shape implements Singleton {
    private Point p1, p2, p3;
    private static SingletonTriangle instance;

    public static SingletonTriangle getInstance() {
        return instance;
    }

    public static SingletonTriangle getInstance(Point p1, Point p2, Point p3, boolean isFilled) {
            if(instance == null) {
                instance = new SingletonTriangle(p1, p2, p3, isFilled);
            } else {
                instance.p1 = p1;
                instance.p2 = p2;
                instance.p3 = p3;
                instance.isFilled = isFilled;
                instance.setPositionAndBounding();
            }

            return instance;
    }

    private SingletonTriangle(Point p1, Point p2, Point p3, boolean isFilled) {
        super();
