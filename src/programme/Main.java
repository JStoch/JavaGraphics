...
public class Main {
    public static void main(String[] args) {
        //make a scene that allows selection
        SelectiveScene scene = new SelectiveScene(new Scene());

        //create a container and put shapes in it
        ...
        //code belows demonstrates selecting the first item found at the location
        /*try {
